<template>
  <div class="p-3">
    ...
    <p>Daniel Grams<br />Schreiberstrasse 2<br />D-38640 Goslar</p>
    <p><strong>E-Mail-Adresse</strong>: info@goslar-service.de</p>
    <p>
      <strong>Impressum</strong>:
      <a href="https://www.goslar-service.de/impressum" target="_blank"
        >https://www.goslar-service.de/impressum</a
      >
    </p>
    ...
    <p>
      Zur Analyse der App-Nutzung wird Microsoft AppCenter verwendet. Die
      Datenschutzerklärung finden Sie unter
      <a href="https://go.microsoft.com/fwlink/?LinkId=248681"
        >https://go.microsoft.com/fwlink/?LinkId=248681</a
      >.
    </p>
    <p>
      Es werden Icons von
      <a href="https://fontawesome.com/privacy">Font Awesome</a> verwendet.
    </p>
    <p>
      Es werden
      <a href="https://lottiefiles.com/page/privacy-policy">Lottie Files</a>
      verwendet.
    </p>
    ...
    <ul class="glossary">
      <li>
        <strong>Besuchsaktionsauswertung:</strong> "Besuchsaktionsauswertung"
    ...
    <ul class="m-elements">
      <li>
        <strong>Begrifflichkeiten:</strong> Personenbezogene Daten,
